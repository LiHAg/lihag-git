    ...
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
                ...
                _divid = $.common.isEmpty(options.divid) ? "bootstrap-table" : options.divid;  //jm.z add at 20190317
                $('#' + _divid).bootstrapTable({
            ...
            savee: function(url, data) {
            	var config = {
        	        ...
        	        success: function(result) {
        	        	...
        	        	$.operate.successCallback(jsonObj);
        	        }
        	    };
        	    $.ajax(config)
            },
