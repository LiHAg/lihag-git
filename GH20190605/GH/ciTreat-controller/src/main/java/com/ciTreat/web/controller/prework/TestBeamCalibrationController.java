 ...
 */
@Controller
@RequestMapping("/testPrework/testBeam")
public class TestBeamCalibrationController extends BaseController {

	private String prefix = "testPrework/testBeam";
	private String prefix_Jnl = "testPrework/testBeamJnl";
	...
	public String beamCalibration(PatientJnl patientJnl, ModelMap mmap) {
		...
		return "testPrework/testBeamJnl/beamJnl";
	}
	...
	public TableDataInfo list(PatientJnl patientJnl) {
		startPage();
		patientJnl.setTestFlag(BusinessContants.TREAT_FLAG_TEST);
