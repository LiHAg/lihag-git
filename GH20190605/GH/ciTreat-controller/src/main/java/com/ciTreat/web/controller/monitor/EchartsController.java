...
import com.golden.monitor.service.DataService;
/**
 *
 * @author jinma.zheng
 *
...
public class EchartsController {
	...
	@PostMapping(value = "linear",
			consumes = MediaType.APPLICATION_JSON_VALUE,
			produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public @ResponseBody String linear(@RequestBody EchartsConfig echartsConfig){
		String gsonOption = EchartsCore.getInstance().adapterScatter(echartsConfig, getLinear()).toString();
		System.out.println("+++linear gsonOption=" + gsonOption);
		return gsonOption;
	}
	
	private Object[][] getLinear(){
