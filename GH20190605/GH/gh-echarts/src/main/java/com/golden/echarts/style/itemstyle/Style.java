...
import com.golden.echarts.Label;
import com.golden.echarts.LabelLine;
import com.golden.echarts.code.Position;
import com.golden.echarts.style.*;
...
public abstract class Style<T> implements Serializable {
	 ...
	 * 饼图标签视觉引导线，默认显示
	 *
	 * @see com.golden.echarts.LabelLine
	 */
	 ...
	 * 区域样式
	 *
	 * @see com.golden.echarts.style.AreaStyle
	 */
	private AreaStyle areaStyle;
	/**
	 * 和弦图 - 弦样式
	 *
	 * @see com.golden.echarts.style.ChordStyle
	 */
	private ChordStyle chordStyle;
	/**
	 * 力导向图 - 弦样式
	 *
	 * @see com.golden.echarts.style.NodeStyle
	 */
	private NodeStyle nodeStyle;
	/**
	 * 力导向图 - 弦样式
	 *
	 * @see com.golden.echarts.style.LinkStyle
	 */
