...
import com.golden.echarts.axis.AxisLabel;
import com.golden.echarts.axis.AxisLine;
import com.golden.echarts.axis.SplitArea;
import com.golden.echarts.axis.SplitLine;
import com.golden.echarts.code.PolarType;
...
public class Polar extends AbstractData<Polar> implements Component {
     ...
     *
     * @see com.golden.echarts.axis.AxisLine
     */
    private AxisLine axisLine;
    /**
     * 坐标轴文本标签，详见axis.axisLabel
     *
     * @see com.golden.echarts.axis.AxisLabel
     */
    private AxisLabel axisLabel;
    /**
     * 分隔区域，默认不显示，属性show控制显示与否，属性areaStyle（详见areaStyle）控制区域样式
     *
     * @see com.golden.echarts.axis.SplitArea
     */
    private SplitArea splitArea;
    /**
     * 分隔线，默认显示，属性show控制显示与否，属性lineStyle（详见lineStyle）控制线条样式
     *
     * @see com.golden.echarts.axis.SplitLine
     */
