...
import com.golden.echarts.code.Y;
...
public abstract class Axis<T> extends AbstractData<T> implements Component {
     ...
     *
     * @see com.golden.echarts.axis.AxisType
     */
    private AxisType type;
    /**
     * 坐标轴类型，横轴默认为类目型'bottom'，纵轴默认为数值型'left'，可选为：'bottom' | 'top' | 'left' | 'right'
     *
     * @see com.golden.echarts.code.X
     * @see com.golden.echarts.code.Y
     */
     ...
     *
     * @see com.golden.echarts.axis.AxisTick
     * @see com.golden.echarts.style.LineStyle
     */
